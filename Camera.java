...
//             return input;
        ...
        final Point RectATopLeftAnchor = new Point((STREAM_WIDTH - WidthRectA) / 2 + 300, ((STREAM_HEIGHT - HeightRectA) / 2) - 100);
...
//        @Override
        public Mat processFrame1(Mat input) {
            inputToY(input);
